...
import { createTraining } from '../../../api/trainings/postTraining';
...
const NewTrainingPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            tags: formData.tags, // Send full tag objects
        ...
        try {
            const response = await createTraining(payload, token);

            if (response.status === 201) {
                setSuccess(true);
            } else {
                setError(response.data.message || 'Error al crear la capacitación.');
            }
        } catch (err) {
    ...
    return (
        <div className="p-1 w-full max-w-5xl mx-auto">
            <h1 className="text-2xl mb-6 font-bold text-primary">Nueva capacitación</h1>
            ...
            {success && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white rounded-lg p-6 w-1/3 text-center">
                        <h2 className="text-xl font-bold text-primary">¡Capacitación publicada!</h2>
                        <p className="text-gray-500 mt-4">
                            De ahora en más vas a poder encontrarla en la sección general de capacitaciones.
                        </p>
                        <button
